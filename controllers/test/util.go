...
func CreateAtlasProject(projectName string, groupID string, namespace string, organizationID string) *mongodbatlasv1alpha1.MongoDBAtlasProject {
	return &mongodbatlasv1alpha1.MongoDBAtlasProject{
